...
import { ChangePasswordAdminComponent } from '../../super-admin/change-password-admin/change-password-admin.component';
...
export class CustomerPasswordChangeComponent implements OnInit {
  ...
  constructor( private formBuilder: FormBuilder,
    public matDialogRef: MatDialogRef<ChangePasswordAdminComponent>,
